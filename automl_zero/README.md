...
Note that the algorithms shown above are already simplified and reordered for better readability. More details about the experiments and the analysis can be found in the [paper](https://github.com/google-research/google-research/tree/master/automl_zero). 
